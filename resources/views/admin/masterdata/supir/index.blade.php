        ...
        <main id="main" class="main">
          ...
          <div class="x_content">
            ...
            <div class="header-row">
              <h2>Tabel Data Supir</h2>
              <a href="/supir/create" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data Supir</a>
            </div>
              ...
              <div class="col-lg-12">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('drivers.destroy', $supir->id) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
